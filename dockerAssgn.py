...
outputString="****|| Location of Text Files: /home/data ||****\n"
...
outputString=outputString+"****|| Process both text files and count no.of words in each text file. ||****\n"
AllFilesWordCount = 0
AllFilesNames = ""
...
outputString = outputString +"\n"
outputString = outputString +"****|| Total number of words in both files ||****\n"
